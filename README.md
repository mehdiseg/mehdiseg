...
<!--ACTIVITE:DEBUT-->
- **22 sept.** · [mehdiseg-informatique](https://github.com/mehdiseg/mehdiseg-informatique) : Site vitrine : depannage informatique, reseau Wi-Fi et montage de PC sur mesure a do…
- **22 sept.** · [roadmap-reseau-bts-sio](https://github.com/mehdiseg/roadmap-reseau-bts-sio) : Feuille de route réseau : ce qui est réalisé, ce qui est testé, ce qui reste à réali…
- **22 sept.** · [projet\_git\_demo](https://github.com/mehdiseg/projet_git_demo) : Exercice de cours sur Git : premiers commits et intégration d'une modification d'un …
- **22 sept.** · [scanner-reseau-powershell](https://github.com/mehdiseg/scanner-reseau-powershell) : Scanner de réseau local en PowerShell : appareils, MAC, ports TCP, remarques de sécu…
- **22 sept.** · [serveur-debian-lemp-securise](https://github.com/mehdiseg/serveur-debian-lemp-securise) : Serveur web Debian 13 : nginx, MariaDB, PHP-FPM et pare-feu UFW \(SSH uniquement\)
<!--ACTIVITE:FIN-->
